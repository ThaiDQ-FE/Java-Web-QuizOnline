...
public class TakeQuizServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int quizTime = sDao.getQuizTimeOfSubject(subjectID);
            int numberQuestion = sDao.getNumberQuestionOfSubject(subjectID);
            List<QuestionDTO> listRandomQuestions = dao.getRandomQuestions(numberQuestion, subjectID);
