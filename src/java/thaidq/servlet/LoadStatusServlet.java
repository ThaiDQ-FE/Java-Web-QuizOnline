...
public class LoadStatusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<StatusDTO> sDTO = sDAO.getAllStatus();
            List<QuestionDTO> qDTO = qDAO.getAllQuestion();
            request.setAttribute("LIST_STATUS", sDTO);
            request.setAttribute("LIST_QUESTION", qDTO);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
