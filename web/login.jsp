        ...
        <div class="container">
            <div class="login-container">
                ...
                <div class="login-form">
                    <h2 class="login-title">Quiz Online</h2>
                    <form action="login" method="POST">
                        <h4>
                            <span class="login-content-text" style="display: none">Hey good to see you again!, Are you ready for the next challenge?</span>
                        ...
                        <input class="login-input email" type="text" name="txtEmail" placeholder="Email Address" required/><br/>
                        <input class="login-input password" type="password" name="txtPassword" placeholder="Password" required/><br/>
                        <p class="login-forget">Forget Password?</p>
                        <input class="login-login" type="submit" value="Login" name="btnAction"/>
                        <div class="login-or">
                            <h1>or</h1>
                        </div>
                        <div class="login-footer">
                            <div class="login-create">
                                <a href="createAccount.jsp">Create</a> account
                            </div>
